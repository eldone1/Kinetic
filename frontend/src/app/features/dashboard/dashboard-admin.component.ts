...
@Component({
  ...
  template: `
    <div class="p-6 space-y-6">
      <h2 class="text-2xl font-bold text-gray-800 font-heading">Dashboard Administrador</h2>

      <!-- KPIs Financieros -->
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <p class="text-sm text-gray-500 font-medium">Ventas del Día</p>
          <p class="text-2xl font-bold text-teal-600 mt-1">S/ {{data?.ventasDelDia | number:'1.2-2'}}</p>
        </div>
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <p class="text-sm text-gray-500 font-medium">Ventas del Mes</p>
          <p class="text-2xl font-bold text-teal-600 mt-1">S/ {{data?.ventasDelMes | number:'1.2-2'}}</p>
        </div>
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <p class="text-sm text-gray-500 font-medium">Ticket Promedio</p>
          <p class="text-2xl font-bold text-teal-600 mt-1">S/ {{data?.ticketPromedio | number:'1.2-2'}}</p>
        </div>
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <p class="text-sm text-gray-500 font-medium">Pacientes Activos</p>
          <p class="text-2xl font-bold text-teal-600 mt-1">{{data?.pacientesActivos}}</p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <p class="text-sm text-gray-500 font-medium">Citas Programadas Hoy</p>
          <p class="text-2xl font-bold text-blue-600 mt-1">{{data?.citasProgramadasHoy}}</p>
        </div>
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        ...
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <p class="text-sm text-gray-500 font-medium">Sesiones Realizadas Hoy</p>
          <p class="text-2xl font-bold text-indigo-600 mt-1">{{data?.sesionesRealizadasHoy}}</p>
        </div>
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <p class="text-sm text-gray-500 font-medium">Cajas Abiertas</p>
          <p class="text-2xl font-bold text-amber-600 mt-1">{{data?.cajasAbiertas}}</p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <h3 class="text-sm font-semibold text-gray-700 mb-4">Ventas Mensuales</h3>
          <canvas baseChart [data]="ventasMensualesData" [options]="barOptions" type="bar"></canvas>
        </div>
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <h3 class="text-sm font-semibold text-gray-700 mb-4">Pacientes por Día (30d)</h3>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <h3 class="text-sm font-semibold text-gray-700 mb-4">Servicios Más Demandados</h3>
          <canvas baseChart [data]="serviciosData" [options]="doughnutOptions" type="doughnut"></canvas>
        </div>
        <div class="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
          <h3 class="text-sm font-semibold text-gray-700 mb-4">Rendimiento por Doctor</h3>
